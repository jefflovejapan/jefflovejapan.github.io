...
- `threadsPerThreadgroup`: `MTLSize(width: 8, height: 8, depth: 1)`. This number is arbitrary and it might be worth experimenting with other multiples of 8 to see the performance impacts on your application.
